...
remove_a_factory(Factory_index) :-

    MetaPredicate_Factories=..[factories,List],
    call(MetaPredicate_Factories),

    transducer(MetaPredicate_Factories, remove_a_factory_transducer, 
        [Factory_index]), !
.  

remove_a_factory_transducer(
...
% :- trace(select_a_random_factory_transducer).